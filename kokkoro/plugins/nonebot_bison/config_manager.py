...
help_match = on_command('help_bison', priority=1)
...
add_sub_matcher = on_command("添加订阅", rule=to_me(), permission=GROUP_OWNER | SUPERUSER, priority=1)
do_add_sub(add_sub_matcher)
manage_add_sub_mather = on_command('管理-添加订阅', permission=SUPERUSER, priority=1)
...
query_sub_macher = on_command("查询订阅", rule=to_me(), priority=1)
do_query_sub(query_sub_macher)
manage_query_sub_mather = on_command('管理-查询订阅', permission=SUPERUSER, priority=1)
...
del_sub_macher = on_command("删除订阅", rule=to_me(), permission=GROUP_OWNER | SUPERUSER, priority=1)
do_del_sub(del_sub_macher)
manage_del_sub_mather = on_command('管理-删除订阅', permission=SUPERUSER, priority=1)
